...
def get_query_performance_metrics(results, topic_num):
    ...
    p_at_1_to_5 = [calculate_precision(results, topic_num, i) for i in range(1, 6)]
    p_at_10_to_25 = [calculate_precision(results, topic_num, i) for i in range(10, 26, 5)]
    p_at_30_to_50 = [calculate_precision(results, topic_num, i) for i in range(30, 51, 10)]
