...
ALLOWED_HOSTS = ['leifos.pythonanywhere.com','64.225.5.100','127.0.0.1']
...
ROOT_URLCONF = 'treconomics_project.urls'
...
WSGI_APPLICATION = 'treconomics_project.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(BASE_DIR, 'treconomics.db'),
    }
}
